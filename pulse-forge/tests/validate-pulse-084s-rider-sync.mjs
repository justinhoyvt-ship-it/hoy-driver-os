...
need(manifest.preserveLiveOnly?.includes('QRLiveRequest.html'), 'QRLiveRequest.html must be preserved');
for (const file of ['Code.gs','RequestForm.html','FareQuote.gs','RiderExperience.gs','appsscript.json']) {
...
need(form.includes('Request sent to your Pulse driver'), 'request success copy missing');
need(form.includes('Watch your inbox for confirmation'), 'request confirmation copy missing');
