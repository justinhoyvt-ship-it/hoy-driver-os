...
function pulseGetFriendRides(){
  ...
  const requestUrl=String(PropertiesService.getScriptProperties().getProperty('PULSE_FRIEND_REQUEST_URL')||'');
  return{
